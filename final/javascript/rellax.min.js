(function (e, c) { "function" === typeof define && define.amd ? define([], c) : "object" === typeof module && module.exports ? module.exports = c() : e.Rellax = c() })(this, function () {
    var e = function (c, l) {
        ...
        b.options = { speed: -2, center: !1 }; l && Object.keys(l).forEach(function (a) {
            b.options[a] = l[a]
        });
        ...
        }, m = function (a, b) { return a < -b ? -b : a > b ? b : a },
            q = function () {
                var a = g;
        ...
        b.destroy = function () { for (var a = 0; a < b.elems.length; a++)b.elems[a].style.cssText = d[a].style; p = !0 };
        (function () {
            k = window.innerHeight;
            q();
            for (var a = 0; a < b.elems.length; a++) {
                var c = u(b.elems[a]); d.push(c)
            }
            window.addEventListener("resize", function () { n() }); r(); n()
        })();
        return b
    };
    return e
